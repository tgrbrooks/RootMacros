...
void TMVAShowerClass( TString myMethodList = "" )
{
   ...
   TString outfileName( "TMVAShower.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVAShowerClass", outputFile,
   ...
   std::cout << "==> TMVAShowerClass is done!" << std::endl;
